        ...
        <div className={styles.forgotPass}>
            <main className={styles.main}>
                <form className={styles.forgotPassForm}>
                    ...
                    <Button extraClass={"mt-6"} htmlType="button" onClick={handleSendResetPasswordMailButtonClick}>Восстановить</Button>
                    <p className={"text text_type_main-default text_color_inactive pt-20 " + styles.emptyMargin}> Вспомнили пароль? <Link className={styles.clearLink} to='/login'>Войти</Link></p>
                </form>
            </main>
        </div>
    );
