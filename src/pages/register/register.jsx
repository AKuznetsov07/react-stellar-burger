        ...
        <div className={styles.register}>
            <main className={styles.main}>
                <form className={styles.registerForm}>
                    <p className={"text text_type_main-medium " + styles.emptyPadding + " " + styles.emptyMargin}>Регистрация</p>
                    ...
                    <Button htmlType="button" extraClass="mt-6" onClick={handleRegisterButtonClick}>Зарегистрироваться</Button>
                    <p className={"text text_type_main-default text_color_inactive pt-20 " + styles.emptyMargin}> Уже зарегестрированы? <Link className={styles.clearLink} to='/login'>Войти</Link></p>
                </form>
            </main>
        </div>
    );
